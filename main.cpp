...
/////////////////////////
        ...
        const float containerHeight = 400.0f; // Wysokość widocznego obszaru
        ...
        for (int i = 0; i < cryptocurrencies.size(); ++i)
        {
            ...
            ImGui::Text("Nazwa: %s", cryptocurrencies[i].first.c_str());
            ImGui::SameLine(500); // Ustawiamy tekst w połowie szerokości
            ImGui::Text("Cena: %.2f USD", cryptocurrencies[i].second);
